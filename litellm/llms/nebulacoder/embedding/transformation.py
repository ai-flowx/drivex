"""
Transformation logic from OpenAI /v1/embeddings format to NebulaCoder's  `/v1/embeddings` format.
"""
...
class NebulaCoderEmbeddingConfig:
    def __init__(
        self,
    ) -> None:
        locals_ = locals().copy()
...
    def get_complete_url(self, api_base: str, model: str, stream: Optional[bool] = None) -> str:
        """
        Override get_complete_url to handle NebulaCoder-specific URL construction.
        If api_base already ends with '/embeddings', don't append it again.
        """
