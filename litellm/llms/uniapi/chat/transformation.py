"""
Translates from OpenAI's `/v1/chat/completions` to UniAPI's `/v1/chat/completions`
"""
...
class UniAPIChatConfig(OpenAIGPTConfig):

    def _transform_messages(
        self, messages: List[AllMessageValues], model: str
    ) -> List[AllMessageValues]:
        """
        UniAPI does not support content in list format.
        """
    ...
    def _get_openai_compatible_provider_info(
        ...
        api_base = (
            api_base
            or get_secret_str("UNIAPI_API_BASE")
    ...
    def get_complete_url(
        ...
        """
        if api_base is None:
            api_base = "https://api.uniapi.io/v1"
