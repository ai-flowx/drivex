...
@pytest.mark.asyncio
async def test_siliconflow_request_format(is_async):
    """
    Test that SiliconFlow requests are formatted correctly with the proper endpoint and parameters
    ...
    assert (
        request_body["model"] == "deepseek-ai/DeepSeek-R1-Distill-Qwen-32B"
